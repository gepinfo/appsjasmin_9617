...
{ path : 'updatedata', loadChildren: () => import('./updatedata/updatedata.module').then(m => m.UpdatedataModule), canActivate: [AuthGuard] } , 
{ path : 'getalldata', loadChildren: () => import('./getalldata/getalldata.module').then(m => m.GetalldataModule), canActivate: [AuthGuard] } , 
];
